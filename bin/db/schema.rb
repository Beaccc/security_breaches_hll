...
ActiveRecord::Schema.define(version: 2020_09_02_162356) do
  ...
  create_table "conversion_filtereds", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "element"
  end
  ...
  create_table "attack_vectors_fase2", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "element"
  end
